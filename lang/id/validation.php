...
/**
 * File bahasa Indonesia untuk pesan validasi Laravel.
 * Digunakan untuk menampilkan pesan error dalam Bahasa Indonesia.
 * 
...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'purpose' => [
            'required' => 'Keperluan wajib dipilih.',
            'in' => 'Keperluan yang dipilih tidak valid.',
        ],
        'item_id' => [
            'required_if' => 'Barang wajib dipilih untuk peminjaman.',
        ],
        'quantity' => [
            'required_if' => 'Jumlah pinjam wajib diisi untuk peminjaman.',
            'integer' => 'Jumlah pinjam harus berupa angka bulat.',
            'min' => 'Jumlah pinjam minimal :min.',
        ],
        'email' => [
        ...
        'total_stock' => [
            ...
            'integer' => 'Total stok harus berupa angka bulat.',
            'min' => 'Total stok minimal :min.',
        ],
        'current_stock' => [
            'required' => 'Stok tersedia wajib diisi.',
            'integer' => 'Stok tersedia harus berupa angka bulat.',
            'lte' => 'Stok tersedia tidak boleh melebihi total aset.',
        ],
        'image' => [
            'required' => 'Gambar wajib diunggah.',
            'image' => 'File harus berupa gambar.',
            'mimes' => 'Gambar harus berformat: jpeg, png, jpg, atau gif.',
